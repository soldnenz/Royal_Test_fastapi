        ...
        <Router>
          <Routes>
            ...
            <Route path="dashboard" element={<DashboardLayout />}>
              ...
              <Route path="subscription" element={<div className="p-4 bg-white dark:bg-gray-800 rounded-lg"><h1 className="text-xl font-bold mb-2">Подписка</h1><p>Страница подписки находится в разработке</p></div>} />

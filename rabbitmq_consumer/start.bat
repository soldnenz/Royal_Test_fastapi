...
echo [%time%] Starting RabbitMQ Consumer service...
...
:: Build the service with no cache to ensure fresh build
...
echo [%time%] Running docker-compose up...
...
if errorlevel 1 (
    ...
    echo [%time%] Service started successfully.
